...
- [ ] P1 权限体验：教师/学生菜单与按钮隐藏逻辑细化（大纲 9.2/10）
...
- [ ] P1 JWT 完整化：`/auth/me`、token 过期策略、角色依赖统一（大纲 9.2/11）
- [ ] P2 文件治理：上传文件大小限制、类型校验、超时与错误码标准化（大纲 9.3）

## 联调与测试剩余

- [ ] P0 功能测试清单跑通（大纲 12.1）
- [ ] P0 权限隔离验证：学生访问教师功能返回 403 + 前端正确拦截（大纲 12.1）
...
- [ ] 完成 **学生接口补全：PUT /students/{id} + CSV 批量导入入口**，打通学生管理闭环。
